  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-12 flex flex-col gap-4">
      ...
      <p className="text-sm leading-relaxed text-ink">
        OTR منصة إعلانات مبوّبة عُمانية تجمع كل ما يُؤجَّر أو يُنقَل في مكان واحد: عقارات، أراضٍ، شاليهات، منتجعات، فنادق،
        سيارات، دراجات، وقوارب — إضافة لخدمات النقل العام والمندوب والرافعات والمعدات الثقيلة والكرفان.
      </p>
      <p className="text-sm leading-relaxed text-ink">
