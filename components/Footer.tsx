    ...
    <footer className="border-t border-line mt-10 bg-white">
      ...
      <div className="max-w-6xl mx-auto px-4 py-8 border-b border-line">
        ...
        <p className="text-sm text-muted leading-relaxed max-w-3xl">
          OTR منصة إعلانات مبوّبة تجمع كل ما يُؤجَّر أو يُنقَل في عُمان بمكان واحد: منازل، سيارات، شاليهات، منتجعات، دراجات،
          قوارب، وخدمات الشاحنات ونقل النفط والمندوب والتاكسي والتوصيل. تصفّح الإعلانات، وتواصل مع المعلن مباشرة عبر
